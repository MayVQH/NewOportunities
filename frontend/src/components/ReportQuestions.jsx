...
const Reportquestion = () => {
    ...
    useEffect(() => {
        ...
        useEffect(() => {
            const fetchThemeData = async () => {
                try {
                    ...
                    const response = await fetch(`${import.meta.env.VITE_BACKEND_ORIGIN}/api/themes/preguntasClave/pregunta/full/${id}`);
        ...
        useEffect(() => {
            const fetchUserKeyQuestion = async () => {
                try {
                    console.log('id de la pregunta clave del front',id)
                    const response = await fetch(`${import.meta.env.VITE_BACKEND_ORIGIN}/api/themes/reporte/totales/${id}`);
    ...
    useEffect(() => {
        ...
        const abrirPopupComentario = async (pregunta) => {
            ...
            try {
              const res = await fetch(`${import.meta.env.VITE_BACKEND_ORIGIN}/api/themes/preguntasClave/comentarios/${pregunta.id_pcp}`);
        ...
        try {
            const res = await fetch(`${import.meta.env.VITE_BACKEND_ORIGIN}/api/themes/preguntasClave/enlaces/${pregunta.id_pcp}`);
            const data = await res.json();
            setEnlaces(data);
        } catch (err) {
        ...
        const abrirPopupDocumento = async (pregunta) => {
            ...
            try {
                const res = await fetch(`${import.meta.env.VITE_BACKEND_ORIGIN}/api/themes/preguntasClave/documentos/${pregunta.id_pcp}`);
                const data = await res.json();
                setDocumentos(data);
            } catch (err) {
        ...
        const confirmSubmit = async () => {
            ...
            try {
                const response = await fetch(`${import.meta.env.VITE_BACKEND_ORIGIN}/api/themes/preguntaClave/guardar/respuestaFinal/${keyQuestion.id}`, {
                    method: 'POST',
                    headers: {
        ...
        const handleEnviarComentarioFinal = async () => {
            ...
            try {
                const response = await fetch(`${import.meta.env.VITE_BACKEND_ORIGIN}/api/themes/preguntaClave/guardar/comentarioFinal/${keyQuestion.id}`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
