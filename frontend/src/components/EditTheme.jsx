...
const EditTheme = () => {
    ...
    useEffect(() => {
        const fetchThemeData = async () => {
            try {
                const response = await fetch(`${import.meta.env.VITE_BACKEND_ORIGIN}/api/themes/full/${id}`);
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await fetch(`${import.meta.env.VITE_BACKEND_ORIGIN}/api/themes/${id}`, {
                method: 'PUT',
