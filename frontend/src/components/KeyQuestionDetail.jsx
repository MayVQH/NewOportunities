...
const KeyquestionDetail = () => {
    ...
    useEffect(() => {
        ...
        const handleMessage = (event) => {
            if (event.origin === `${import.meta.env.VITE_BACKEND_ORIGINN}` && event.data.user){
    ...
    useEffect(() => {
        const fetchKeyQuestion = async () => {
            ...
            try {
                const response = await fetch(`${import.meta.env.VITE_BACKEND_ORIGIN}/api/themes/preguntaClave/all/preguntas/preguntaClave/${pc_id}/${pcp_id}`);
                if (!response.ok) {
    ...
    useEffect(() => {
        const fetchAnswerKeyQuestion = async () => {
            ...
            try {
                const response = await fetch(`${import.meta.env.VITE_BACKEND_ORIGIN}/api/themes/preguntasClave/respuestas/${pcp_id}`);
    ...
    useEffect(() => {
        ...
        const handleOpenPopup = async (usuario) => {
            ...
            try {
                const res = await fetch(`${import.meta.env.VITE_BACKEND_ORIGIN}/api/themes/preguntasClave/comentarios/${keyQuestions.pcp_id}/${usuario.usuario_id}`);
          ...
          const handleOpenDocument = async (usuario) => {
            ...
            try {
                const res = await fetch(`${import.meta.env.VITE_BACKEND_ORIGIN}/api/themes/preguntasClave/documentos/${keyQuestions.pcp_id}/${usuario.usuario_id}`);
                const datos = await res.json();
                setDocumentos(datos);
              } catch (err) {
          ...
          const handleOpenUrl = async (usuario) => {
            ...
            try {
                const res = await fetch(`${import.meta.env.VITE_BACKEND_ORIGIN}/themes/preguntasClave/enlaces/${keyQuestions.pcp_id}/${usuario.usuario_id}`);
                const datos = await res.json();
                setUrls(datos);
              } catch (err) {
                console.error('Error al obtener comentarios:', err);
